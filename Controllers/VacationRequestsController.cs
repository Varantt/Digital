...
namespace Digital.Controllers
{
    public class VacationRequestsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,EmployeeId,StartDate,EndDate,HeadOfDepartmentApproval,OperationsApproval,Status")] VacationRequest vacationRequest)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,EmployeeId,StartDate,EndDate,HeadOfDepartmentApproval,OperationsApproval,Status")] VacationRequest vacationRequest)
        {
