...
namespace Digital.Controllers
{
    public class ApprovalsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,VacationRequestId,ApproverId,ApprovalDate,Comments")] Approval approval)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,VacationRequestId,ApproverId,ApprovalDate,Comments")] Approval approval)
        {
            if (id != approval.Id)
            {
                return NotFound();
